...
Mobile.setText(findTestObject('TC03_Edit Produk/android.widget.EditText - Nama Produk'), 'Baju dan Celana', 0)

Mobile.setText(findTestObject('TC03_Edit Produk/android.widget.EditText - Deskripsi Produk'), 'Cuci dan Setrika', 0)

Mobile.setText(findTestObject('TC03_Edit Produk/android.widget.EditText - Harga'), '20000', 0)

Mobile.tap(findTestObject('TC03_Edit Produk/android.widget.RadioButton - Kg'), 0)
